...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { date: @notice.date, loginuser_id: @notice.loginuser_id, memo: @notice.memo, title: @notice.title }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { date: @notice.date, loginuser_id: @notice.loginuser_id, memo: @notice.memo, title: @notice.title }
    assert_redirected_to notice_path(assigns(:notice))
  end
